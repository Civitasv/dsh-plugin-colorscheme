# dsh-plugin-colorscheme — 一键安装脚本（Windows / PowerShell）
#
...
Write-Host '    验证：  dsh --profile web --dump-config | Select-String dsh-plugin-colorscheme'
Write-Host '    重启后打开 设置 → 插件 → 插件配置 → 配色方案 卡片即可切换主题。'
